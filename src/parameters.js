...
export const PARAMETER_SCHEMA = Object.freeze({
  ...
  intensity: number(0, 1, 0.82, "Intensity", "Source"),
  tenseness: number(0, 1, 0.62, "Tenseness", "Source"),
  loudness: number(0, 1.5, 1, "Loudness", "Source"),
  voicing: number(0, 1, 1, "Voicing", "Source"),
  aspiration: number(0, 1, 0.18, "Breath", "Source"),
  vibrato: number(0, 1, 0.18, "Vibrato", "Source"),
  wobble: number(0, 1, 0, "Wobble", "Source"),
  tongueIndex: number(12, 29, 17.5, "Tongue position", "Tract"),
  tongueDiameter: number(2.05, 3.5, 2.75, "Tongue height", "Tract"),
